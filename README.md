# Rainbow Say - Логопедический центр "Радуга слов"
...
### Квизы и анкеты
- Создание квизов с вопросами разных типов:
...
- Автоматическое определение результата по набранным баллам
- Сохранение всех отправок квизов с данными пользователя
...
- Статьи
- Контакты
- Квизы (динамические страницы по slug)
...
### Quizzes API
- `GET /api/quizzes/quizzes/` - список квизов
- `GET /api/quizzes/quizzes/{slug}/by_slug/` - квиз по slug
- `POST /api/quizzes/quizzes/{id}/submit/` - отправка квиза
