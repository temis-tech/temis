...
2. **Автоматически создавать статьи** из постов в Telegram канале:
   - При создании нового поста в канале автоматически создается статья на сайте
   - Изображения из поста загружаются и используются в статье
...
- Система автоматически:
  ...
  - Создает статью на сайте с заголовком из текста поста
  - Использует изображение из поста в статье
