...
class ContentPageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Услуги для отображения', {
            ...
            'description': 'Выберите услуги, которые будут отображаться на этой странице. Услуги будут автоматически фильтроваться по выбранному филиалу пользователя, если он указан. Подходит для страниц типа "Описание" и "Каталог".'
        }),
