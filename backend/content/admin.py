...
class CatalogItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Страница элемента', {
            ...
            'description': 'Настройки страницы элемента (отображается при открытии карточки, если включен режим "Может быть открыт как страница"). Здесь можно задать полное описание, изображение, видео (YouTube, Rutube и т.д.) и параметры отображения.'
        }),
        ('Настройки', {
