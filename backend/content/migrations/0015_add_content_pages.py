    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('button_type', models.CharField(choices=[('booking', 'Запись'), ('quiz', 'Квиз'), ('external', 'Внешняя ссылка'), ('none', 'Без кнопки')], default='none', max_length=20, verbose_name='Тип кнопки')),
                ...
                ('quiz_slug', models.CharField(blank=True, help_text='Если тип кнопки - "Квиз"', max_length=200, verbose_name='Slug квиза')),
