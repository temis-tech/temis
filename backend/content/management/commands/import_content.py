    ...
    def import_services(self):
        ...
        services_data = [
            ...
            },
            {
                ...
                'description': 'Профессиональная помощь в решении проблем речи в игровом формате. Специалист найдет подход даже к самому скромному малышу. Мы работаем над развитием речи, коммуникативных навыков, подготовкой к школе. Используем методики, соответствующие возрасту.',
...
• С 2017 года — учитель-логопед и владелица частного детского центра''',
    ...
    def import_reviews(self):
        ...
        reviews_data = [
            ...
            {
                'author_name': 'Елена',
                'text': 'Замечательные специалисты, нашли подход к нашему ребенку. Занятия проходят в игровой форме, ребенку нравится.',
                'rating': 5,
                'order': 3,
            },
        ]
