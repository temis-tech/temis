        ...
        services_data = [
            {
                ...
                'short_description': 'Индивидуальные занятия с опытным логопедом для детей',
                'price': 2400,
            ...
            {
                'title': 'Запуск речи',
                'description': 'Программа запуска речи помогает ребенку произнести первые слова и фразы. Мы создаем среду, где речь возникает естественно, применяя логопедический подход с помощью мотивации и игры. В работе используем пальчиковые игры для активации речевых центров мозга и артикуляционную гимнастику.',
        ...
        specialists_data = [
            {
                ...
                'position': 'Логопед-дефектолог, Специалист по сенсорной интеграции',
