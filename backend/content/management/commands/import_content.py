        ...
        services_data = [
            {
                ...
                'description': 'Профессиональная помощь в развитии речи и коммуникативных навыков. Индивидуальный подход. Работаем над развитием речи, коммуникативных навыков, подготовкой к школе. Используем современные методики.',
                'price': 2400,
            ...
            {
                'title': 'Запуск речи',
                'description': 'Программа запуска речи помогает произнести первые слова и фразы. Мы создаем среду, где речь возникает естественно, применяя профессиональный подход с помощью мотивации и игры. В работе используем пальчиковые игры для активации речевых центров мозга и артикуляционную гимнастику.',
                'price': 2400,
                'price_with_abonement': 2200,
                'order': 2,
            },
            {
                ...
                'description': 'Выявляем речевые, интеллектуальные, поведенческие трудности, определяем уровень развития психических функций. Развиваем внимание, память, логическое мышление. Помогаем осваивать необходимые для школы навыки: счет, чтение письмо. Скорректируем поведение, научим коммуникации. Работаем с особенностями развития: ЗПР, ЗПРР, СДВГ, РАС, УО и другими нарушениями.',
                'price': 2400,
                'price_with_abonement': 2200,
                'order': 3,
            },
            ...
            },
            {
                ...
                'description': 'Поможем заговорить чисто и уверенно. С помощью техник звукопостановки мы увлекательно учим правильно произносить сложные звуки. Учитываем индивидуальные особенности. Всё проходит в игровой форме, а когда звук появится мы автоматизируем его с помощью интересных нейроупражнений, для активного закрепления звука в свободной речи.',
                'price': 2400,
                'price_with_abonement': 2200,
                'order': 5,
            },
            {
                'title': 'Специалист по развитию речи',
                'description': 'Профессиональная помощь в решении проблем речи в игровом формате. Специалист найдет индивидуальный подход. Мы работаем над развитием речи, коммуникативных навыков, подготовкой к школе. Используем современные методики.',
                'price': 2400,
                'price_with_abonement': 2200,
                'order': 6,
            },
            {
                ...
                'description': 'Коррекция нарушений письма: пропуски или путаница букв, зеркальное написание, ошибки. Определим вид дисграфии и устраним её причину. Ключевая роль отводится развитию фонематического слуха. В сложных случаях эффективен массаж, улучшающий нейромышечную связь.',
                'price': 2400,
                'price_with_abonement': 2200,
                'order': 7,
            },
        ...
        specialists_data = [
            {
                ...
                'bio': '''Коррекция сенсорно-интегративных дисфункций при РАС, СДВГ и ментальных нарушениях.
...
• Сенсорная интеграция: Диагностика и коррекция нарушений обработки сенсорной информации (тактильная, вестибулярная, проприоцептивная системы). Адаптация среды при гипер-/гипочувствительности.
...
• Работа с целевыми группами: РАС (аутизм), ментальные нарушения, генетические синдромы.
• Поддержка семей: Обучение родителей методам АВА и сенсорной интеграции.''',
            ...
            },
            {
                ...
                'position': 'Специалист по развитию речи',
                'bio': '''Высшее образование: Специалитет по специальности "Развитие речи" (2015 г.)
Профессиональная переподготовка: "Образование" (2016 г., ГАОУ ДПО "ЛОИРО").

Специализация и повышение квалификации:
• Массаж: Технологии коррекционно-педагогического воздействия на мышцы лица и артикуляционного аппарата (АНО «Академия ДПО», Курган, 2020 г., 108 ч.)
• Запуск речи: Специфика организации и проведения работы по развитию речи (АНО ДПО «Северо-Западная Академия ДПО», СПб, 2021 г., 108 ч.)
• Участник профессиональных конференций по развитию речи (СПб, 2018 г.)''',
                'branch': branch_udelnaya,
                'order': 2,
            },
            {
                'name': 'Сывороткина Екатерина Михайловна',
                'position': 'Специалист по развитию речи широкого профиля',
                'bio': '''Ключевая квалификация:
• Профессиональная переподготовка: Специалист по развитию речи (Институт специальной педагогики и психологии им. Р. Валленберга, Санкт-Петербург, 2023 г.)
• Тьюторское сопровождение при РАС и ТМНР (ООО «Учебный центр «Моя Планета», Москва, 2025 г., 72 ч.)
• Дефектология: Работа с интеллектуальной недостаточностью, особенностями коммуникации и интеллекта (Онлайн-стажировка, курсы О.А. Тарасовой, 2025 г.)
• Нейроподход: Применение нейроматематики в коррекционной работе

Специализация и углубленные методики:
• Коррекция звукопроизношения и дикции: Постановка звуков, полная автоматизация, работа над разборчивостью речи
• Артикуляционная гимнастика: Эффективные методики подготовительного этапа
• Работа с различными возрастными группами''',
...
• Массаж (классический, зондовый, массаж ложками)
...
• Поддержка семей: обучение методам домашней коррекции и сенсорной интеграции

Образование:
• Уральский государственный педагогический университет (УрГПУ) — педагог, 2001 г.
• Уральский государственный педагогический университет (УрГПУ) — специалист по развитию речи, 2011 г.

Повышение квалификации:
• Семинар-практикум «Клиникоориентированный подход в практике. Введение в миофункциональную коррекцию», 2025 г.
• Повышение квалификации «Современные технологии коррекции нарушений постановки звуков» (144 часа), 2025 г.
• Повышение квалификации «Массаж. Классический, зондовый и массаж ложками», 2024 г.
...
• 6 лет — воспитатель
• 6 лет — методист
• С 2017 года — специалист по развитию речи и владелица центра''',
                'branch': branch_rybatskoe,
                'order': 4,
            },
        ]
    ...
    def import_reviews(self):
        ...
        reviews_data = [
            {
                'author_name': 'Мария',
                'text': 'Отличный центр! Очень благодарны специалистам!',
                'rating': 5,
                'order': 1,
            },
            {
            ...
            {
                'author_name': 'Елена',
                'text': 'Замечательные специалисты, нашли индивидуальный подход. Занятия проходят в игровой форме.',
                'rating': 5,
                'order': 3,
            },
        ]
    ...
    def import_promotions(self):
        ...
        promotions_data = [
            {
                'title': 'Акция на индивидуальные занятия',
                'description': 'Специальное предложение на курс занятий. Профессиональная помощь в развитии речи.',
                'order': 1,
            },
            {
                'title': 'Курс индивидуальных занятий',
        ...
        articles_data = [
            {
                ...
                'short_description': 'Как развивать речь через специальные упражнения',
                'content': '''
                    <h2>Тренировка мозга для развития речи</h2>
                    <p>Развитие речи - это комплексный процесс, который требует внимания к различным аспектам развития мозга. В нашем центре мы используем специальные методики для тренировки мозга.</p>
                    <h3>Нейроигры</h3>
                    <p>Нейроигры помогают активировать речевые центры мозга и улучшить координацию движений. Эти упражнения особенно эффективны при задержке речевого развития.</p>
            ...
            {
                'title': 'Формирование правильного произношения',
                'short_description': 'Как научиться правильно произносить звуки',
                'content': '''
