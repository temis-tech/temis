...
class Command(BaseCommand):
    ...
    def import_hero_settings(self):
        ...
        settings, created = HeroSettings.objects.get_or_create(
            pk=1,
            defaults={
                'title': 'Логопедический центр «Радуга слов» - занятия с опытным логопедом',
...
Настоящая Политика конфиденциальности определяет порядок обработки и защиты персональных данных пользователей сайта logoped-spb.pro (далее — Сайт), принадлежащего логопедическому центру "Радуга слов" (далее — Центр).
